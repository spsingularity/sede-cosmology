...
\texttt{{[}Zenodo\ DOI\ —\ to\ be\ assigned{]}}. The repository ships
the model package (the background E(z), w(z), the structure gate
\(f_{\mathrm{sat}}\), and the halo-binding \(\gamma\) derivation), the
public data vectors, the figure generators, and the
