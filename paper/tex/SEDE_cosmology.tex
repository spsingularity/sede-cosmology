...
responsibility for its content. Artificial-intelligence tools --- Claude
Opus 4.x (Anthropic) --- assisted with drafting and editing the
manuscript, developing and cross-checking the analysis code, and
literature searches; all output, including every literature reference,
was checked by the author, who takes full responsibility for the
